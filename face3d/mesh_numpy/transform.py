...
# rotate vertices by using ratation matrix
...
# Notice: affine matrix P consists of s, R and t
# get affineMatrix P    3d --> 3d
...
# get affineMatrix P    3d (world) --> 2d (image)
...
# obtain s, R and t from affine matrix P
def P2sRt(P):
...
# obtain pitch, yaw and roll angles
def matrix2angle(R):
